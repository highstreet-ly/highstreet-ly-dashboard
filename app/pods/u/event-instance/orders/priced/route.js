...
export default class UEventInstanceOrdersPricedRoute extends Route.extend(AuthenticatedRouteMixin) {
    @service
    contextService;
    ...
    setupController(controller) {
        ...
        controller.set('ordersQuery', {
            filter: `expr:and(equals(event-instance-id,'${this.contextService.eventInstance.id}'),equals(status,'Priced'))`,
